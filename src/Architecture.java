...
//		
//		
//		ECU ecu = new ECU(1, 2.4, Architecture.getInstance());
//		ecu.setBus(bus1);
//		
//		IntraECUBus bus2 = new IntraECUBus(200);
//		ECU ecu2 = new ECU(2, 2.4, Architecture.getInstance());
//		ecu2.setBus(bus2);
//		
//		
//		bus.ecus.add(ecu);
...
//		
//		
//		core.scheduler.execute2(100);	
//		core2.scheduler.execute2(100);	
//		
//		Util.printLog(Architecture.getInstance());
		
		for (ECU e : this.ecus) {
			for (Core c : e.cores) {
//				int firstSWComponent = -1;
//				if (c.id == 1) {
//					firstSWComponent = 1;
//				} else if (c.id == 2) {
//					firstSWComponent = 2;
