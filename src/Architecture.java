...
public class Architecture {
	...
	public static void main(String[] args) {
		...
		core.scheduler.tasks.add(new OsTask(0, 15, new MessageParams(1, 23), core, tr1));
		core.scheduler.tasks.add(new OsTask(1, 25, new MessageParams(1, 23), core, tr2));
		core.scheduler.tasks.add(new OsTask(2, 40, new MessageParams(1, 23), core, tr3));
